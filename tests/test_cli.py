...
class CliTests(unittest.TestCase):
    def test_copy_mode_preserves_source_and_writes_github_file(self):
    ...
    def test_replace_mode_updates_source(self):
        with tempfile.TemporaryDirectory() as tmp:
            root = Path(tmp)
            ...
            self.assertEqual(source.read_text(encoding="utf-8"), "前文\n\n$$\nx=1\n$$\n")
